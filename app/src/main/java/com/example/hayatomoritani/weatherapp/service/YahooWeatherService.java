...
public class YahooWeatherService {
    ...
    public void refreshWeather(String loc){
        ...
        new AsyncTask<String, Void, String>() {
            ...
            protected void onPostExecute(String s) {
                ...
                try {
                    ...
                    JSONObject qureyResult = data.optJSONObject("query");
                    int count = qureyResult.optInt("count");
                    ...
                    channel.populate(qureyResult.optJSONObject("results").optJSONObject("channel"));
        ...
        }.execute(location); //strings up there is an array, so string[0]= location (which is passed in the execute method)
    }
